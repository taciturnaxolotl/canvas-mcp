	...
	const server = new Server(
		{
			...
			title: "Canvas LMS",
			description:
				"Access your Canvas courses, assignments, grades, and announcements",
			websiteUrl: BASE_URL,
			icons: [
				{
			...
			inputSchema: {
				...
				properties: {
					course_id: {
						type: "number",
						description:
							"Optional course ID to get announcements from a specific course. If not provided, returns announcements from all courses.",
					},
					limit: {
						type: "number",
						description:
							"Maximum number of announcements to return (1-50). Default is 10.",
					},
				},
			},
		},
			...
			inputSchema: {
				...
				properties: {
					course_id: {
						type: "number",
						description:
							"Optional course ID to get detailed grades and submissions for a specific course. If not provided, returns summary grades for all courses.",
					},
				},
			},
		},
